...
//homeSpan.setLogLevel(1); // Ставим 1, чтобы не засорять эфир при шифровании
  ...
  homeSpan.setWifiCredentials("YOUR_WIFI_SSID", "YOUR_WIFI_PASSWORD");  // ⚠️ Укажите имя и пароль вашей WiFi сети

  // Совет: если после прошивки в приложении Дом видны NULL-значения, смените Setup ID на новый, чтобы iPhone перечитал структуру сервисов
homeSpan.begin(Category::AirConditioners, "AC1", "YOUR_HOMEKIT_PAIRING_CODE", "YOUR_SETUP_ID");  // ⚠️ Укажите свой 8-значный код сопряжения HomeKit (например, 466-37-726) и Setup ID из 4 символов (буквы/цифры), см. README
